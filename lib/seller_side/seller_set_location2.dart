...
class SellerSetLocation2 extends StatefulWidget {
  const SellerSetLocation2({super.key});

  @override
  State<SellerSetLocation2> createState() => SellerSetLocation2State();
}

class SellerSetLocation2State extends State<SellerSetLocation2> {
